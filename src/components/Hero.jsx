  ...
  return (
    <div className="text-white">
      <div className="max-w-[1000px] mt-[-96px] w-full h-screen mx-auto text-center flex flex-col justify-center">
        ...
        <h1 className="md:text-7x sm:text-6xl text-4xl font-bold md:py-5">
          Grow with data
        </h1>
        <div className="flex justify-center items-center">
          ...
          <Typed
            strings={["BTC", "ECT", "XAF", "SASS"]}
            typeSpeed={120}
            backSpeed={180}
            loop
            className="text-gray-600 md:text-5xl sm:text-4xl text-xl font-bold pl-2"
          />
        </div>
        <p className="pt-2 md:text-2xl text-xl text-gray-600 ">
